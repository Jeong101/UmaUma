...
create sequence storeNo_seq start with 2 increment by 1;
...
values(storeNo_seq.nextVal,'버거킹','1599-0505','대전광역시 중구 용두동 29-5', 36.3251767, 127.4091049,'./image/burgerking.png','a');

insert into store(storeNo,storeName,storePhone,address,longitude,latitude,imgUrl,foodcode)
values(storeNo_seq.nextVal,'계동치킨','042-528-9920','대전광역시 중구 태평1동 263-12', 36.3233664   ,127.3908232,'./image/kyedong.jpg','b');

insert into store(storeNo,storeName,storePhone,address,longitude,latitude,imgUrl,foodcode)
values(storeNo_seq.nextVal,'뽕뜨락피자','042-528-9920','대전광역시 중구 태평1동 330-20',36.3233658,127.3907803,'./image/bbong.png','c');

insert into store(storeNo,storeName,storePhone,address,longitude,latitude,imgUrl,foodcode)
values(storeNo_seq.nextVal,'롯데리아','042-535-8491','대전광역시 중구 태평동 408-11', 36.3233651, 127.3907374,'./image/lotteria.png','a');
...
insert into store(storeNo,storeName,storePhone,address,longitude,latitude,imgUrl,foodcode)
values(storeNo_seq.nextVal,'청해루 24시','042-257-6591','대전광역시 중구 문화동 1-36', 36.3199421,127.4123182,'./image/chung_240.jpg','i,j');
...
insert into store(storeNo,storeName,storePhone,address,longitude,latitude,imgUrl,foodcode)
values(storeNo_seq.nextVal,'남다른대구막창','042-471-5529','대전광역시 중구 오류동 159-10', 36.322105,127.408403,'./image/namda.png','f,g');
...
insert into food values(8,2,'연어샐러드',10000 );
